import { require_react_dom } from "./chunk-7BTQE24S.js";
import { require_react } from "./chunk-UNLUE3XC.js";
...
function createRouter(init) {
  ...
  async function handleAction(
    ...
    if (isRedirectResult(result)) {
      ...
      if (opts && opts.replace != null) {
        ...
        replace2 =
          location22 === state.location.pathname + state.location.search;
      }
  ...
  async function handleLoaders(
    ...
    let loadingNavigation =
      overrideNavigation || getLoadingNavigation(location2, submission);
...
function getTargetMatch(matches, location2) {
  let search =
    typeof location2 === "string"
      ? parsePath(location2).search
      : location2.search;
  if (
...
var AwaitContextProvider = (props) =>
...
function useOutlet(context) {
  ...
  return React2.useMemo(
    () =>
      outlet &&
      React2.createElement(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
function UNSTABLE_TransitionEnabledRouterProvider({
  ...
  React3.useLayoutEffect(() => {
    return router2.subscribe(
      (
        newState,
        { deletedFetchers, flushSync: flushSync3, viewTransitionOpts }
      ) => {
...
`
                      ...
                      const values = encoder3.stringified
      ...
      dataRoute.lazy = {
        ...
        middleware: route.hasClientMiddleware
          ? async () => {
              ...
              invariant2(
                clientMiddleware,
                "No `clientMiddleware` export found"
              );
    ...
    (event) => {
      if (shouldProcessLinkClick(event, target)) {
        ...
        let replace2 =
          replaceProp !== void 0
            ? replaceProp
            : createPath(location2) === createPath(path);
        navigate(to, {
          replace: replace2,
          state,
          preventScrollReset,
  ...
  return routes.map((route) => {
    ...
    let newRoute = {
      ...
      ErrorBoundary: route.ErrorBoundary
        ...
        : void 0,
      action: route.action
        ? (args) => route.action({ ...args, context })
        : void 0,
      loader: route.loader
        ? (args) => route.loader({ ...args, context })
        : void 0,
...
function generateSingleFetchRedirectResponse(
  redirectResponse,
  request,
  build,
  serverMode
...
var RSCRouterGlobalErrorBoundary = class extends import_react.default
  .Component {
  constructor(props) {
    super(props);
